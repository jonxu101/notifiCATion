...
var backgroundJS = chrome.extension.getBackgroundPage(),
    ...
    renderControlMaxUnproductiveTime = function() {
        var e = {
            min: 0,
            max: [UNPRODUCTIVE_TIME_TABLE.length - 1],
            raw: getSliderRawFromComputed(UNPRODUCTIVE_TIME_TABLE, UNPRODUCTIVE_TIME_DEFAULT, backgroundJS.settings.unproductiveTime),
            computed: getUnproductiveTimeComputedString(backgroundJS.settings.unproductiveTime),
            "default": getUnproductiveTimeComputedString(UNPRODUCTIVE_TIME_DEFAULT)
        };
        html = tplHtmlMaxUnproductiveTimeControl(e), htmlRenderInto("unproductive-time", html)
    },
    ...
    renderUI = function() {
        renderUIRange(RANGE_TODAY, RESOLUTION_HOURS, !0, !0, !0), renderUIRange(RANGE_AVERAGE, RESOLUTION_HOURS, !0, !0, !1), renderUIRange(RANGE_ALLTIME, RESOLUTION_DAYS, !0, !0, !0), renderControlIdleTime(), renderControlGraphGap(), renderControlMaxUnproductiveTime(), renderControlBadgeDisplay(), clearOverallStats(), dcl("UI rendered")
    },
...
}), addMultipleDelegatedEventListeners("#pseudomodal #unproductive-time .slider", "input,change", function(e, t) {
    var n = t.value,
        a = getUnproductiveTimeComputedFromRaw(n),
        r = getUnproductiveTimeComputedString(a);
    return document.querySelector("#pseudomodal #unproductive-time .display").innerHTML = r, "change" === e.type && (backgroundJS.setTimeUnproductive(a), backgroundJS.saveTimeUnproductive(), dcl("Unproductive time saved: " + a)), !0
...
}), addMultipleDelegatedEventListeners("#pseudomodal .options-unproductive", "click", function(e, t) {
    document.querySelector("#pseudomodal").dataset.visibility = n;
    var a = htmlTemplates.querySelector("#screenshot-info-instructions-list"),
        r = document.importNode(a.content, !0);
    elementInsertIntoElement(document.querySelector("#pseudomodal .container.screenshot .list"), r)
...
var restoreFromJson = function(e) {
        ...
        return sha256(i).then(function(e) {
            o.hash.sha256 === e || SKIP_RESTORE_HASH_CHECK ? (o.hash.sha256 !== e && dcl("Restore - hashes mismatch!"), 
            backgroundJS.domains = o.content.domains, 
            backgroundJS.dates.start = o.content.dates.start, 
            backgroundJS.seconds.today = getTotalSecondsForDate(o.content.domains, getDateString()), 
            ...
            backgroundJS.saveTimeUnproductive(), 
            renderUI(), 
            s(), 
            dcl("Restore - done!")) : (r(), dcl("Restore - data corrupted"))
        }), !0
    },
