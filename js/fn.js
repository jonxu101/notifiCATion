...
var dclCounter = 0,
    ...
    getUnproductiveTimeComputedString = function(e) {
        var t;
        return e + " minutes"
    },
    getUnproductiveTimeComputedFromRaw = function(e) {
        var t = UNPRODUCTIVE_TIME_TABLE[e];
        return "undefined" == typeof t && (t = UNPRODUCTIVE_TIME_DEFAULT, console.error("Undefined raw value: " + e)), t
    },
